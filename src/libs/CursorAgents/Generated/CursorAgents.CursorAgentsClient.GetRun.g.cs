...
namespace CursorAgents
{
    public partial class CursorAgentsClient
    {
        ...
        private static readonly global::CursorAgents.EndPointSecurityRequirement s_GetRunSecurityRequirement0 =
        ...
        private static readonly global::CursorAgents.EndPointSecurityRequirement[] s_GetRunSecurityRequirements =
            new global::CursorAgents.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::CursorAgents.Run> GetRunAsync(
            string id,
            string runId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CursorAgents.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CursorAgents.AutoSDKHttpResponse<global::CursorAgents.Run>> GetRunAsResponseAsync(
            string id,
            string runId,
            global::CursorAgents.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CursorAgents.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CursorAgents.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/v1/agents/{id}/runs/{runId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::CursorAgents.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::CursorAgents.Run.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::CursorAgents.AutoSDKHttpResponse<global::CursorAgents.Run>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::CursorAgents.Run.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
