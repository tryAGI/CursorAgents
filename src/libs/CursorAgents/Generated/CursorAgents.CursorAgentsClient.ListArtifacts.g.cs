...
namespace CursorAgents
{
    public partial class CursorAgentsClient
    {
        ...
        private static readonly global::CursorAgents.EndPointSecurityRequirement s_ListArtifactsSecurityRequirement0 =
        ...
        private static readonly global::CursorAgents.EndPointSecurityRequirement[] s_ListArtifactsSecurityRequirements =
            new global::CursorAgents.EndPointSecurityRequirement[]
            {                s_ListArtifactsSecurityRequirement0,
            };
        partial void PrepareListArtifactsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareListArtifactsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessListArtifactsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListArtifactsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CursorAgents.ListArtifactsResponse> ListArtifactsAsync(
            string id,
            global::CursorAgents.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ListArtifactsAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CursorAgents.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CursorAgents.AutoSDKHttpResponse<global::CursorAgents.ListArtifactsResponse>> ListArtifactsAsResponseAsync(
            string id,
            global::CursorAgents.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::CursorAgents.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListArtifactsSecurityRequirements,
                operationName: "ListArtifactsAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CursorAgents.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CursorAgents.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListArtifactsAsync",
                                pathTemplate: "$\"/v1/agents/{id}/artifacts\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::CursorAgents.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListArtifactsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::CursorAgents.ListArtifactsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::CursorAgents.AutoSDKHttpResponse<global::CursorAgents.ListArtifactsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::CursorAgents.ListArtifactsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
