...
namespace CursorAgents
{
    public partial class CursorAgentsClient
    {
        ...
        private static readonly global::CursorAgents.EndPointSecurityRequirement s_GetApiKeyInfoSecurityRequirement0 =
        ...
        private static readonly global::CursorAgents.EndPointSecurityRequirement[] s_GetApiKeyInfoSecurityRequirements =
            new global::CursorAgents.EndPointSecurityRequirement[]
            {                s_GetApiKeyInfoSecurityRequirement0,
            };
        partial void PrepareGetApiKeyInfoArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareGetApiKeyInfoRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessGetApiKeyInfoResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetApiKeyInfoResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CursorAgents.ApiKeyInfo> GetApiKeyInfoAsync(
            global::CursorAgents.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetApiKeyInfoAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CursorAgents.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CursorAgents.AutoSDKHttpResponse<global::CursorAgents.ApiKeyInfo>> GetApiKeyInfoAsResponseAsync(
            global::CursorAgents.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetApiKeyInfoArguments(
                httpClient: HttpClient);


            var __authorizations = global::CursorAgents.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetApiKeyInfoSecurityRequirements,
                operationName: "GetApiKeyInfoAsync");
                ...
                else
                {
                    await global::CursorAgents.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetApiKeyInfoResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::CursorAgents.ApiKeyInfo.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::CursorAgents.AutoSDKHttpResponse<global::CursorAgents.ApiKeyInfo>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::CursorAgents.ApiKeyInfo.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
