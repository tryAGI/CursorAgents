...
namespace CursorAgents
{
    ...
    public sealed partial class AgentEnv
    {
        ...
        /// <summary>
        /// Named Cursor-hosted environment, Team Pool, or self-hosted machine name. For `type: pool`, this is the pool name (defaults to `default` when omitted). Unknown pool names return `400`. Omit `repos` with `type: pool` to target a repo-less pool.<br/>
