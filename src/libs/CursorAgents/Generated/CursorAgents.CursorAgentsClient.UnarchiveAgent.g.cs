...
namespace CursorAgents
{
    public partial class CursorAgentsClient
    {
        ...
        private static readonly global::CursorAgents.EndPointSecurityRequirement s_UnarchiveAgentSecurityRequirement0 =
        ...
        private static readonly global::CursorAgents.EndPointSecurityRequirement[] s_UnarchiveAgentSecurityRequirements =
            new global::CursorAgents.EndPointSecurityRequirement[]
            {                s_UnarchiveAgentSecurityRequirement0,
            };
        partial void PrepareUnarchiveAgentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareUnarchiveAgentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessUnarchiveAgentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUnarchiveAgentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CursorAgents.IdResponse> UnarchiveAgentAsync(
            string id,
            global::CursorAgents.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await UnarchiveAgentAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CursorAgents.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CursorAgents.AutoSDKHttpResponse<global::CursorAgents.IdResponse>> UnarchiveAgentAsResponseAsync(
            string id,
            global::CursorAgents.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareUnarchiveAgentArguments(
            ...
            var __authorizations = global::CursorAgents.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UnarchiveAgentSecurityRequirements,
                operationName: "UnarchiveAgentAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CursorAgents.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CursorAgents.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UnarchiveAgentAsync",
                                pathTemplate: "$\"/v1/agents/{id}/unarchive\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::CursorAgents.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUnarchiveAgentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::CursorAgents.IdResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::CursorAgents.AutoSDKHttpResponse<global::CursorAgents.IdResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::CursorAgents.IdResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
