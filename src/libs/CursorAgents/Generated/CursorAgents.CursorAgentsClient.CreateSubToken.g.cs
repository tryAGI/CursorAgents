...
namespace CursorAgents
{
    public partial class CursorAgentsClient
    {
        ...
        private static readonly global::CursorAgents.EndPointSecurityRequirement s_CreateSubTokenSecurityRequirement0 =
        ...
        private static readonly global::CursorAgents.EndPointSecurityRequirement[] s_CreateSubTokenSecurityRequirements =
            new global::CursorAgents.EndPointSecurityRequirement[]
            {                s_CreateSubTokenSecurityRequirement0,
            };
        partial void PrepareCreateSubTokenArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::CursorAgents.CreateSubTokenRequest request);
        partial void PrepareCreateSubTokenRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::CursorAgents.CreateSubTokenRequest request);
        partial void ProcessCreateSubTokenResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateSubTokenResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CursorAgents.CreateSubTokenResponse> CreateSubTokenAsync(

            global::CursorAgents.CreateSubTokenRequest request,
            global::CursorAgents.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateSubTokenAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CursorAgents.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CursorAgents.AutoSDKHttpResponse<global::CursorAgents.CreateSubTokenResponse>> CreateSubTokenAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateSubTokenArguments(
            ...
            var __authorizations = global::CursorAgents.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateSubTokenSecurityRequirements,
                operationName: "CreateSubTokenAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CursorAgents.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CursorAgents.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateSubTokenAsync",
                                pathTemplate: "\"/v1/sub-tokens\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::CursorAgents.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateSubTokenResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::CursorAgents.CreateSubTokenResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::CursorAgents.AutoSDKHttpResponse<global::CursorAgents.CreateSubTokenResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::CursorAgents.CreateSubTokenResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::CursorAgents.CreateSubTokenResponse> CreateSubTokenAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::CursorAgents.CreateSubTokenRequest
            {
                ForUserEmail = forUserEmail,
                ForUserId = forUserId,
            };

            return await CreateSubTokenAsync(
                request: __request,
                requestOptions: requestOptions,
