...
namespace CursorAgents
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::CursorAgents.AutoSDKRetryOptions Retry { get; set; } = new global::CursorAgents.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::CursorAgents.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::CursorAgents.IAutoSDKHook>();
        ...
        public global::CursorAgents.AutoSDKClientOptions AddHook(
            global::CursorAgents.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::CursorAgents.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::CursorAgents.AutoSDKClientOptions UseAuthorizationProvider(
            global::CursorAgents.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::CursorAgents.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::CursorAgents.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::CursorAgents.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::CursorAgents.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::CursorAgents.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::CursorAgents.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::CursorAgents.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::CursorAgents.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::CursorAgents.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::CursorAgents.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::CursorAgents.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::CursorAgents.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::CursorAgents.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::CursorAgents.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::CursorAgents.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::CursorAgents.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::CursorAgents.AutoSDKClientOptions clientOptions,
            global::CursorAgents.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::CursorAgents.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::CursorAgents.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::CursorAgents.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::CursorAgents.AutoSDKClientOptions clientOptions,
            global::System.Func<global::CursorAgents.IAutoSDKHook, global::CursorAgents.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::CursorAgents.AutoSDKHookContext context)
        {
